      ...
      <div className="contect-div">
       ...
       <div className="contact-image">
        ...
        <div className="right-div-contact">
          ...
          >
          {whatsapp&&<div className="icon icon-whatsapp">
           <img src={whatsapp} alt={whatsapp} className="icon-imgg icon-whatsapp" />  </div>}
          <div className="icon-text">WhatsApp</div>
          
          </Link>
          <Link className="contactLink contact-tel" to={"tel:+91 8107775019"}>
          {call&&<div className="icon icon-whatsapp">
           <img src={call} alt="call" className="icon-imgg icon-whatsapp" />  </div>}
          ...
          >
          {insta&&<div className="icon icon-whatsapp">
           <img src={insta} alt="call" className="icon-imgg icon-instagram" />  </div>}
        ...
        <div className="left-div-contact">
          ...
          >
          {facebook&&<div className="icon icon-whatsapp">
           <img src={facebook} alt="" className="icon-imgg icon-fb" />  </div>}
          ...
          >
           {mail&&<div className="icon icon-mail">
           <img src={mail} alt="" className="icon-imgg icon-fb" />  </div>}
          ...
          >
          {linkedin&&<div className="icon icon-mail">
           <img src={linkedin} alt="" className="icon-imgg icon-fb" />  </div>}
